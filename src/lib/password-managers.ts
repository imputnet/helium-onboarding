...
export const passwordManagers: Record<string, PasswordManagerInfo> = {
    protonPass: {
        title: "Proton Pass",
        description: "Secure password manager by Proton. Stores data only in Switzerland and Europe. All clients are open-source. Free with an optional paid plan.",
    ...
    bitwarden: {
        title: "Bitwarden",
        description: "The most popular open-source password manager. Offers data storage in Europe or US, with self-hosting available. Free with an optional paid plan.",
